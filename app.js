...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  let string2 = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + product2 + '.';
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  let stringOfArray = sumArr + ' was passed in as an array of numbers, and ' + sum2 + ' is their sum.';
  return [sum2, stringOfArray];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  for(let i = 0; i < dynamicArray.length-1; i++){
    if (i === 0) {
      product = multiply(dynamicArray[i], dynamicArray[i+1])[0];
      console.log(product);
    }
    else { 
